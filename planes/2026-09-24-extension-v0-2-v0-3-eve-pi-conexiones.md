...
| **T0.5** | Glosario: términos nuevos en `registry/glossary.yaml` (steering, follow-up, paso durable, espera aparcada, dirección de continuación, conexión, fuente de datos, Agent Card, audiencia, lift, manifiesto de agente…) | `build-all` en verde |
